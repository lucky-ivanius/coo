/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 1adb1d8672453dc2a098166e3e3853f3)
...
declare namespace Cloudflare {
	...
	interface Env {
		COO_DB: D1Database;
		COO_CORE_CONTRACT: string;
		WEBHOOK_SECRET: string;
		CHAINHOOKS_SECRET: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COO_CORE_CONTRACT" | "WEBHOOK_SECRET" | "CHAINHOOKS_SECRET">> {}
}
