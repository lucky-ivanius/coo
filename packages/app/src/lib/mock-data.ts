 ...
 *
 * Fields mapping:
 *   id              ← sha256(identifier ++ claim ++ bond-sats ++ liveness ++ asserted-at-block)
 *   identifier      ← buff 32 (UTF-8 encoded)
...
export const MOCK_ASSERTIONS: Assertion[] = [
  {
    id: "a3f1e2b4c5d6e7f8901234567890abcdef1234567890abcdef1234567890ab12",
    identifier: enc.encode("BTC/USD"),
    claim: enc.encode("The BTC/USD spot price exceeded $100,000 USD at Stacks block height 99,800, as reported by three independent price oracles."),
    claimHash: enc.encode("3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e"),
    asserter: "SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR",
    bondSats: 50_000,
    liveness: 1440,
    status: ASSERTION_STATUS.ASSERTED,
    assertedAtBlock: 99_800,
  },
  {
    id: "b7d2f3a4e5c6b7a8901234567890abcdef1234567890abcdef1234567890cd34",
    identifier: enc.encode("TEMP/NYC"),
    claim: enc.encode(
    ...
    claimHash: enc.encode("4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f"),
  ...
  {
    id: "c8e3a1b2d4f5c6d7e8901234567890abcdef1234567890abcdef1234567890ef56",
    identifier: enc.encode("SCORE/NFL"),
    claim: enc.encode(
      "The Kansas City Chiefs scored more than 28 points in Super Bowl LX, played on February 8, 2026, as reported by official NFL game records."
    ),
    claimHash: enc.encode("5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a"),
  ...
  {
    id: "d9f4b2c3e5a6d7e8f9012345678901234567890abcdef1234567890abcdef7890",
    identifier: enc.encode("ETH/USD"),
    claim: enc.encode(
      "Ethereum's average gas fee remained below 5 gwei for 144 consecutive Stacks blocks ending at block 98,200, as measured by on-chain data."
    ),
    claimHash: enc.encode("6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b"),
  ...
  {
    id: "e0a5c3d4f6b7e8f9a012345678901234567890abcdef1234567890abcdef9012",
    identifier: enc.encode("POP/EARTH"),
    claim: enc.encode(
      "Global human population surpassed 8.2 billion people as of January 1, 2026, according to the United Nations World Population Prospects report."
    ),
    claimHash: enc.encode("7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c"),
  ...
  {
    id: "f1b6d4e5a7c8f9a0b1234567890123456789abcdef1234567890abcdef0123ab",
    identifier: enc.encode("OIL/BBL"),
    claim: enc.encode(
    ...
    claimHash: enc.encode("8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d"),
  ...
  {
    // Awaiting settlement: ASSERTED status but liveness window has already closed
    // expiryBlock = 98,000 + 100 = 98,100 < MOCK_CURRENT_BLOCK (100,000)
    id: "a2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2",
    identifier: enc.encode("FLIGHT/LAX"),
    claim: enc.encode(
    ...
    claimHash: enc.encode("9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e"),
