...
import { computeAssertionId, ERR_ASSERTION_ALREADY_EXISTS, ERR_ASSERTION_BOND_TOO_LOW, ERR_ASSERTION_INVALID_LIVENESS } from "./fixtures/assertion";
...
describe("Core", () => {
  ...
  describe("assert", () => {
    ...
    it("transfers sBTC bond from caller to contract", () => {
      ...
      simnet.callPublicFn(contractName, "assert", [identifier, claim, Cl.uint(10_000), Cl.none()], wallet1);
